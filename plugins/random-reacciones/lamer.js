...
export default {
  ...
  execute: async (sock, msg, { from }) => {
    ...
    if (!targetJid) {
      const helpText = `> *Etiqueta a quien le quieras dar un postre hoy...* 😋🔥\n\n` +
    ...
    try {
      ...
      // 6. Mensaje con el drama: el que usa el comando es el que realiza la acción
      const txt = `*¡Qué delicia!* @${selfJid.split('@')[0]} le está dando un festín inolvidable a @${victimJid.split('@')[0]} 🤭🔥`
